...
public class FashionMNIST {
    ...
    public static double[] labels(String path) {
        try {
            ...
            in.close();
            System.out.println(String.format("found %d labels from the Fashion-MNIST dataset", items));
            return (result);
        } catch (Exception e) {
            return (null);
        }
    ...
    public static double[][] images(String path) {
        try {
            ...
            in.close();
            System.out.println(String.format("found %d images with size %dx%d from the Fashion-MNIST dataset", items, rows, columns));
            return (result);
        } catch (Exception e) {
            return (null);
        }
